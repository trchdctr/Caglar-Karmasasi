...
const enemy = new Fighter({
  ...
  sprites: {
    ...
    run: {
      imageSrc: './img/raven/Run.png',
      framesMax: 8
    },
    jump: {
      imageSrc: './img/raven/Jump.png',
      framesMax: 2
    },
    fall: {
      imageSrc: './img/raven/Fall.png',
      framesMax: 2
    },
    attack1: {
      imageSrc: './img/raven/Attack2.png',
      framesMax: 5
    },
    takeHit: {
      imageSrc: './img/raven/Take Hit.png',
      framesMax: 3
    },
    death: {
      imageSrc: './img/raven/Death.png',
      framesMax: 8
    }
  },
  attackBox: {
